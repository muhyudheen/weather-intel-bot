...
Rules:
1. If the message is weather-related AND contains a clear city/location, set "is_weather": true and fill:
...
2. If the message is weather-related BUT has NO city or location mentioned (e.g. "what is the weather today?", "is it raining?", "will it snow?"), set:
   {"is_weather": true, "needs_location": true}

3. If the message is NOT weather-related, set only "is_weather": false.

4. Never invent coordinates. If you are unsure about a city, set "ambiguous": true and pick the most famous match.

Examples:
{"is_weather":true,"needs_location":false,"city":"Delhi","country":"India","latitude":28.6139,"longitude":77.2090,"query_type":"current","forecast_days":null,"ambiguous":false,"ambiguity_note":null}
{"is_weather":true,"needs_location":false,"city":"Paris","country":"France","latitude":48.8566,"longitude":2.3522,"query_type":"forecast","forecast_days":3,"ambiguous":true,"ambiguity_note":"Defaulted to Paris, France — there is also Paris, Texas, USA"}
{"is_weather":true,"needs_location":true}
{"is_weather":false}
""".strip()
